   ...
   <body id="page-top">
      ...
      <div id="wrapper">
            ...
            <li class="nav-item">
               ...
               <div id="Salary" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                     ...
                     <router-link to="/given-salary" class="collapse-item">Salary</router-link>
            ...
            <li class="nav-item">
               ...
               <div id="Order" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                     ...
                     <router-link to="/today-order" class="collapse-item">Today Order</router-link>
                     <router-link to="/search-order" class="collapse-item">Search</router-link>
                  </div>
               </div>
            </li>
            <li class="nav-item">
         ...
         <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
               <!-- TopBar -->
               <nav class="navbar navbar-expand navbar-light bg-navbar topbar mb-4 static-top" id="topbar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forgot' ? false : true" style="display: none;">
                  ...
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item dropdown no-arrow">
                        ...
                        <img class="img-profile rounded-circle" src="{{ asset('backend/img/boy.png')}}" style="max-width: 60px">
                           {{-- <?php
                              $userId = Auth::id();
                              $me = DB::table('users')->where('id',$userId)->first();
                           ?> --}}
