            ...
            <div class="">
               ...
               <div class="card mb-4 ">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                     ...
                     <router-link to=/supplier class="btn btn-sms btn-primary">All Supplier</router-link>
                  </div>
                  <div class="card-body">
                        ...
                        <div class="form-group">
                           <div class="row">
                              <div class="col">
                                 ...
                                 <input type="text" class="form-control" placeholder="Enter Supplier Name" v-model="form.supplier_name">
                        ...
                        <div class="form-group">
                           <div class="row">
                              <div class="col">
                                 ...
                                 <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Shop Name" v-model="form.shopname">
